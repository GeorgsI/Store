...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 08 2022 г., 17:03
...
CREATE TABLE `goods` (
  ...
  `code` int NOT NULL,
  `YN` int NOT NULL,
  ` priceRose` decimal(10,0) DEFAULT NULL,
...
--
ALTER TABLE `accesssale`
  MODIFY `idaccessSale` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `closuretable`
  MODIFY `id_closureTable` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `goods`
--
ALTER TABLE `goods`
  MODIFY `id_goods` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `kitpromo`
  MODIFY `id_kitPromo` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `phones`
  MODIFY `id_phones` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `photogoods`
--
ALTER TABLE `photogoods`
  MODIFY `id_photoGoods` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `promolabel`
--
ALTER TABLE `promolabel`
  MODIFY `id_promoLabel` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `specificationscategory`
  MODIFY `id_specificationsCategory` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `specificationstitle`
--
ALTER TABLE `specificationstitle`
  MODIFY `id_specificationsTitle` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `specificationsvalue`
--
ALTER TABLE `specificationsvalue`
  MODIFY `id_specificationsValue` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `userphoto`
  MODIFY `id_userPhoto` int NOT NULL AUTO_INCREMENT;
