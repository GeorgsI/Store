    ...
    public function render(){
        echo "<section class='superPrise__Block'>
                <div class='superPrise__container'>
                        ...
                        <li class='superPrise__item'>
                            ...
                            <span class='superPrise__item-photo-wrepper'>
                                <picture>
                                    ...
                                    <img src='images/Lenovo Tab P11 Plus TB-J616F 64GB ZA940029RU/lenovo-tab-m10-plus-gen-3-feature-1.jpg' class='superPrise__item-img' alt=''>
                                </picture>
                            </span>
                            <span class='superPrise__innertextWrepper'>
                                <span class='superPrise__item-title'>
                    ...
                    <a href='index.php?page=PagePromo' class='superPrise-all__btn btn'>Все акции</a>   
                </div>
                </div>
            </section>";
    }
